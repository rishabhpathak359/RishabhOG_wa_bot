...
//     // const number = '918789287414@c.us';  
//     // const number = '918468054031@c.us';  
//     const text = 'Hello!';

//     // Sending message
//     // setInterval(()=>{
//     //     client.sendMessage(number, text).then(response => {
...
//             fs.writeFile(mediaPath,data,async (err)=>{
//                 if(err){
//                     console.log("failed to save file");
//                 }
//                 else{
//                     console.log("File saved successfully");
//                     const media1 = new MessageMedia('image/jpeg', media.data);
//                     await message.reply(media1);
//                 }
//             })
//             fs.readFile(internalmediapath, (err, data) => {
//                 if (err) {
//                     console.error('File read error', err);
//                     return;
//                 }
//                 const media3 = new MessageMedia(fileMimeType, data.toString('base64'), null);
//                 message.reply(media3)
